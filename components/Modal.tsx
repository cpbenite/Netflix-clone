...
import { PlusIcon, XIcon, ThumbUpIcon, VolumeOffIcon, VolumeUpIcon } from '@heroicons/react/outline'
...
function Modal() {
  ...
  // Fetch movie whenever movie changes
  useEffect(() => {
    if (!movie) return
      ...
      <>
        ...
        <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-8">
          <div className="space-y-6 text-lg">
            ...
            {/* Description. Mobile: Column view. Medium breakpoint:  */}
